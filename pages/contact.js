        ...
        <div className="page-details !max-w-screen-lg">
          ...
          >
            ...
            <label className="input relative">
              ...
              />
              <span className="input__label py-[6px] absolute left-0 top-0 my-[7px] mx-1 origin-top-left translate-x-0 translate-y-0 cursor-text whitespace-nowrap bg-white-500 px-3 font-h">
                Message
              </span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
